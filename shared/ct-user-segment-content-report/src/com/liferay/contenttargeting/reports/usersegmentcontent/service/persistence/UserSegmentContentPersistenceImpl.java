...
import com.liferay.contenttargeting.reports.usersegmentcontent.NoSuchUserSegmentContentException;
import com.liferay.contenttargeting.reports.usersegmentcontent.model.UserSegmentContent;
import com.liferay.contenttargeting.reports.usersegmentcontent.model.impl.UserSegmentContentImpl;
import com.liferay.contenttargeting.reports.usersegmentcontent.model.impl.UserSegmentContentModelImpl;
...
public class UserSegmentContentPersistenceImpl extends BasePersistenceImpl<UserSegmentContent>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERSEGMENTID =
		new FinderPath(UserSegmentContentModelImpl.ENTITY_CACHE_ENABLED,
			...
			UserSegmentContentModelImpl.CREATEDATE_COLUMN_BITMASK);
	 ...
	 */
	@Override
	public UserSegmentContent[] findByUserSegmentId_PrevAndNext(long id,
		long userSegmentId, OrderByComparator orderByComparator)
		throws NoSuchUserSegmentContentException, SystemException {
		UserSegmentContent userSegmentContent = findByPrimaryKey(id);
	...
	public List<UserSegmentContent> findByC_GtD(long userSegmentId,
		...
		return findByC_GtD(userSegmentId, createDate, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<UserSegmentContent> findByC_GtD(long userSegmentId,
		...
		return findByC_GtD(userSegmentId, createDate, start, end, null);
	}
	...
	public List<UserSegmentContent> findByC_GtD(long userSegmentId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (UserSegmentContent userSegmentContent : list) {
				if ((userSegmentId != userSegmentContent.getUserSegmentId()) ||
						(createDate.getTime() >= userSegmentContent.getCreateDate()
																	   .getTime())) {
					list = null;
	...
	public UserSegmentContent fetchByC_GtD_First(long userSegmentId,
		Date createDate, OrderByComparator orderByComparator)
		throws SystemException {
		List<UserSegmentContent> list = findByC_GtD(userSegmentId, createDate,
	...
	public UserSegmentContent fetchByC_GtD_Last(long userSegmentId,
		Date createDate, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByC_GtD(userSegmentId, createDate);
	 ...
	 */
	@Override
	public UserSegmentContent[] findByC_GtD_PrevAndNext(long id,
		long userSegmentId, Date createDate, OrderByComparator orderByComparator)
		throws NoSuchUserSegmentContentException, SystemException {
		UserSegmentContent userSegmentContent = findByPrimaryKey(id);
		...
		try {
			...
			array[0] = getByC_GtD_PrevAndNext(session, userSegmentContent,
					userSegmentId, createDate, orderByComparator, true);

			array[1] = userSegmentContent;

			array[2] = getByC_GtD_PrevAndNext(session, userSegmentContent,
					userSegmentId, createDate, orderByComparator, false);
	 ...
	 */
	@Override
	public void removeByC_GtD(long userSegmentId, Date createDate)
		throws SystemException {
		for (UserSegmentContent userSegmentContent : findByC_GtD(
				userSegmentId, createDate, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(userSegmentContent);
		}
	}
	 ...
	 */
	@Override
	public int countByC_GtD(long userSegmentId, Date createDate)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_GTD;

		Object[] finderArgs = new Object[] { userSegmentId, createDate };
	...
	private static final String _FINDER_COLUMN_C_GTD_CREATEDATE_1 = "userSegmentContent.createDate > NULL";
	private static final String _FINDER_COLUMN_C_GTD_CREATEDATE_2 = "userSegmentContent.createDate > ?";
	 ...
	 */
	@Override
	public UserSegmentContent remove(long id)
		throws NoSuchUserSegmentContentException, SystemException {
	...
	protected UserSegmentContent toUnwrappedModel(
		...
		userSegmentContentImpl.setId(userSegmentContent.getId());
		...
		userSegmentContentImpl.setCreateDate(userSegmentContent.getCreateDate());
	 ...
	 */
	@Override
	public UserSegmentContent findByPrimaryKey(long id)
		throws NoSuchUserSegmentContentException, SystemException {
	 ...
	 */
	@Override
	public UserSegmentContent fetchByPrimaryKey(long id)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.contenttargeting.reports.usersegmentcontent.model.UserSegmentContent")));
