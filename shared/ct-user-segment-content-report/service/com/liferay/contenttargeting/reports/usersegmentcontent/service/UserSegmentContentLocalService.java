...
/**
 * Provides the local service interface for UserSegmentContent. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserSegmentContentLocalServiceUtil
...
public interface UserSegmentContentLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserSegmentContentLocalServiceUtil} to access the user segment content local service. Add custom service methods to {@link com.liferay.contenttargeting.reports.usersegmentcontent.service.impl.UserSegmentContentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
