...
public abstract class CampaignContentLocalServiceBaseImpl
	 ...
	 */
	@Override
	public CampaignContent createCampaignContent(long id) {
		return campaignContentPersistence.create(id);
	}
	...
	@Override
	public CampaignContent deleteCampaignContent(long id)
		throws PortalException, SystemException {
		return campaignContentPersistence.remove(id);
	}
	...
	@Override
	public CampaignContent fetchCampaignContent(long id)
		throws SystemException {
		return campaignContentPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public CampaignContent getCampaignContent(long id)
		throws PortalException, SystemException {
		return campaignContentPersistence.findByPrimaryKey(id);
	}
