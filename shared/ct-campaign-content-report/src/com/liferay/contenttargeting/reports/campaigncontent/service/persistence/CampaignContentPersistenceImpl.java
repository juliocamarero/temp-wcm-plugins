...
import com.liferay.contenttargeting.reports.campaigncontent.NoSuchCampaignContentException;
import com.liferay.contenttargeting.reports.campaigncontent.model.CampaignContent;
import com.liferay.contenttargeting.reports.campaigncontent.model.impl.CampaignContentImpl;
import com.liferay.contenttargeting.reports.campaigncontent.model.impl.CampaignContentModelImpl;
...
public class CampaignContentPersistenceImpl extends BasePersistenceImpl<CampaignContent>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CAMPAIGNID =
		new FinderPath(CampaignContentModelImpl.ENTITY_CACHE_ENABLED,
			...
			CampaignContentModelImpl.CREATEDATE_COLUMN_BITMASK);
	 ...
	 *
	 * @param id the primary key of the current campaign content
	 * @param campaignId the campaign ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public CampaignContent[] findByCampaignId_PrevAndNext(long id,
		long campaignId, OrderByComparator orderByComparator)
		throws NoSuchCampaignContentException, SystemException {
		CampaignContent campaignContent = findByPrimaryKey(id);
	...
	/**
	 * Returns all the campaign contents where campaignId = &#63; and createDate &gt; &#63;.
	 *
	 * @param campaignId the campaign ID
	 ...
	 */
	@Override
	public List<CampaignContent> findByC_GtD(long campaignId, Date createDate)
		throws SystemException {
		return findByC_GtD(campaignId, createDate, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the campaign contents where campaignId = &#63; and createDate &gt; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.contenttargeting.reports.campaigncontent.model.impl.CampaignContentModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<CampaignContent> findByC_GtD(long campaignId, Date createDate,
		...
		return findByC_GtD(campaignId, createDate, start, end, null);
	}

	/**
	 * Returns an ordered range of all the campaign contents where campaignId = &#63; and createDate &gt; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.contenttargeting.reports.campaigncontent.model.impl.CampaignContentModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<CampaignContent> findByC_GtD(long campaignId, Date createDate,
		...
		if ((list != null) && !list.isEmpty()) {
			for (CampaignContent campaignContent : list) {
				if ((campaignId != campaignContent.getCampaignId()) ||
						(createDate.getTime() >= campaignContent.getCreateDate()
																	.getTime())) {
					list = null;
	...
	/**
	 * Returns the first campaign content in the ordered set where campaignId = &#63; and createDate &gt; &#63;.
	 *
	 * @param campaignId the campaign ID
	 * @param createDate the create date
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public CampaignContent findByC_GtD_First(long campaignId, Date createDate,
		OrderByComparator orderByComparator)
		throws NoSuchCampaignContentException, SystemException {
	 ...
	 */
	@Override
	public CampaignContent fetchByC_GtD_First(long campaignId, Date createDate,
		OrderByComparator orderByComparator) throws SystemException {
		List<CampaignContent> list = findByC_GtD(campaignId, createDate, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last campaign content in the ordered set where campaignId = &#63; and createDate &gt; &#63;.
	 *
	 * @param campaignId the campaign ID
	 * @param createDate the create date
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public CampaignContent findByC_GtD_Last(long campaignId, Date createDate,
		OrderByComparator orderByComparator)
		throws NoSuchCampaignContentException, SystemException {
	 ...
	 */
	@Override
	public CampaignContent fetchByC_GtD_Last(long campaignId, Date createDate,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByC_GtD(campaignId, createDate);

		if (count == 0) {
			return null;
		}

		List<CampaignContent> list = findByC_GtD(campaignId, createDate,
	...
	/**
	 * Returns the campaign contents before and after the current campaign content in the ordered set where campaignId = &#63; and createDate &gt; &#63;.
	 *
	 * @param id the primary key of the current campaign content
	 * @param campaignId the campaign ID
	 * @param createDate the create date
	 ...
	 */
	@Override
	public CampaignContent[] findByC_GtD_PrevAndNext(long id, long campaignId,
		...
		try {
			...
			array[0] = getByC_GtD_PrevAndNext(session, campaignContent,
					campaignId, createDate, orderByComparator, true);

			array[1] = campaignContent;

			array[2] = getByC_GtD_PrevAndNext(session, campaignContent,
					campaignId, createDate, orderByComparator, false);
	...
	protected CampaignContent getByC_GtD_PrevAndNext(Session session,
		CampaignContent campaignContent, long campaignId, Date createDate,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the campaign contents where campaignId = &#63; and createDate &gt; &#63; from the database.
	 *
	 * @param campaignId the campaign ID
	 * @param createDate the create date
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public void removeByC_GtD(long campaignId, Date createDate)
		throws SystemException {
	...
	/**
	 * Returns the number of campaign contents where campaignId = &#63; and createDate &gt; &#63;.
	 *
	 * @param campaignId the campaign ID
	 * @param createDate the create date
	 * @return the number of matching campaign contents
	 ...
	 */
	@Override
	public int countByC_GtD(long campaignId, Date createDate)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_GTD;

		Object[] finderArgs = new Object[] { campaignId, createDate };
	...
	private static final String _FINDER_COLUMN_C_GTD_CREATEDATE_1 = "campaignContent.createDate > NULL";
	private static final String _FINDER_COLUMN_C_GTD_CREATEDATE_2 = "campaignContent.createDate > ?";
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"CampaignContentPersistenceImpl.fetchByC_C_C_E(long, String, long, String, boolean) with parameters (" +
	 ...
	 *
	 * @param id the primary key for the new campaign content
	 * @return the new campaign content
	 */
	@Override
	public CampaignContent create(long id) {
		CampaignContent campaignContent = new CampaignContentImpl();

		campaignContent.setNew(true);
		campaignContent.setPrimaryKey(id);
	 ...
	 *
	 * @param id the primary key of the campaign content
	 * @return the campaign content that was removed
	 * @throws com.liferay.contenttargeting.reports.campaigncontent.NoSuchCampaignContentException if a campaign content with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public CampaignContent remove(long id)
		throws NoSuchCampaignContentException, SystemException {
	...
	protected CampaignContent toUnwrappedModel(CampaignContent campaignContent) {
		...
		campaignContentImpl.setId(campaignContent.getId());
	 ...
	 */
	@Override
	public CampaignContent findByPrimaryKey(long id)
		throws NoSuchCampaignContentException, SystemException {
	 ...
	 */
	@Override
	public CampaignContent fetchByPrimaryKey(long id) throws SystemException {
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.contenttargeting.reports.campaigncontent.model.CampaignContent")));
