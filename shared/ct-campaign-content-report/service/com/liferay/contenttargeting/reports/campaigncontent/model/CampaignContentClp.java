...
import com.liferay.contenttargeting.reports.campaigncontent.service.ClpSerializer;
	...
	public void setId(long id) {
		...
		if (_campaignContentRemoteModel != null) {
			try {
				...
				method.invoke(_campaignContentRemoteModel, id);
			}
			catch (Exception e) {
	...
	public void setCreateDate(Date createDate) {
		...
		if (_campaignContentRemoteModel != null) {
			try {
				...
				method.invoke(_campaignContentRemoteModel, createDate);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
